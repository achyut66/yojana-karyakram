        ...
        <div class="maincontent">
                ...
                <?php $data1=  Plandetails1::find_by_id($_GET['id']);?>
                     <?php $data=  Plandetails1::find_by_id($_GET['id']);
                        ...
                        ?>
                     <h3 class="myheader"> योजनाको अनुदान विवरण  
                     </h3>
                    <div class="mycontent">
                     ...
                     <?php if(empty($data)){?><h3 class="myheader">  योजनाको कुल लागत अनुमान थप विवरण भरिएको छैन  </h3><?php }else{?>
                       ...
                       <form method="get" action="amanat_kul_lagat_delete.php">
                       <button name="plan_id" class="button btn-danger" value="<?php echo $_GET['id']?>">विवरण हटाउनुहोस</button></a>
                       </form>
                       </h3>
                        ...
                        <div class="mycontent" >
                        	<div class="inputWrap100">
                                ...
                                <div class="inputWrap33 inputWrapLeft">
                                    ...
                                    <div class="titleInput"> नगद साझेदारी रकम :रु. <span class="underline"><?php echo convertedcit(placeholder($data->costumer_agreement));?></span></div>
                                </div><!-- input wrap 33 ends -->
                                <div class="inputWrap33 inputWrapLeft">
                                    ...
                                    <div class="titleInput"> जनश्रमदान रकम  : रु. <span class="underline"><?php echo convertedcit(placeholder($data->costumer_investment));?></span></div>
                     ...
                     <?php } ?>
                       <?php $data= Amanat_more_details::find_by_plan_id($_GET['id']); ?>
                         ...
                         <form method="get" action="amanat_more_details_delete.php">
                           <button name="plan_id" class="button btn-danger" value="<?php echo $_GET['id']?>">विवरण हटाउनुहोस</button></a>
                         </form>
                         </h3>
                          <div class="mycontent" >
                          	<div class="inputWrap100">
                            	<div class="inputWrap33 inputWrapLeft">
                                	<div class="titleInput">योजना संचालन गर्नेको नाम थर : <span class="underline"><?php echo $data->organizer_name;?></span></div>
                                    <div class="titleInput">योजना संचालन हुने स्थान: <span class="underline"><?php echo $data->place_to_organize;?></span></div>
                                </div><!-- input wrap 33 ends -->
                                <div class="inputWrap33 inputWrapLeft">
                          ...
                          <h3 class="myheader"> योजनाबाट लाभान्वित घरधुरी तथा परिवारको विवरण
                          </h3>
                            <div class="mycontent" >
                           ...
                           <div class="mycontent">
                           		<div class="inputWrap100">
                                	<div class="inputWrap33 inputWrapLeft">
                                        ...
                                        <div class="titleInput"> खर्च स्वीकृत गरेको मिति : <span class="underline"><?=convertedcit($data_selected_final->upabhokta_aproved_date)?></span></div>
