...
foreach($program_payment_final as $final)
{
    ...
    if($_POST['type']==0)
    {
        ...
        $yojana_array = array('कु. वि. न.','सम्झौता भ. योजन','भुक्तानी ल. योजना','पे. भ. योजना','अ. भ. योजना');
    ...
    elseif($_POST['type']==1)
    {
        ...
        $karyakam_count = array($program_count,$program_count1,$budget_rem_details['count'],$program_count2,$no_budget_rem_details["count"]);
        $karyakam_array = array('कु.कार्यक्रम','वि.नभरिएको','खर्च भ. स.नभएको','पे.भुक्तानी','अन्तिम भुक्तानी'); 
         $colors= array("193,66,66","191, 127, 63","191, 191, 63","127, 191, 63","63, 191, 63","63, 191, 127","63, 191, 191","63, 127, 191","127, 63, 191","63, 63, 191");
