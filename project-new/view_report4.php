...
<body>
    ...
    <div id="body_wrap_inner"> 
        ...
        <div class="maincontent">
            <h2 class="headinguserprofile">पेश्की भुक्तानी लागेको योजनाको रिपोर्ट हेर्नुहोस | <a href="report.php" class="btn">पछि जानुहोस </a> | <a href="view_report4_excel.php?ward_no=<?=$_GET['ward_no']?>" class="btn">Excel Export</a> | <a target="_blank" href="view_report4_print.php?ward_no=<?=$_GET['ward_no']?>" class="btn">Print</a></h2>
                     ...
                     <table class="table table-bordered table-hover">
                         ...
                         endforeach;?>
                                <tr>
                                    <td colspan="7">&nbsp; </td>     
                             <td>जम्मा </td>
                             <td ><?php echo convertedcit(placeholder($total_investment5)); ?></td>
                             ...
                             <td colspan="2"><?php echo convertedcit(placeholder($total_remaining_amount)); ?></td>
                                  ...
                                  <?php } else {?>
                                  <h3>पेश्की भुक्तानी लागिएको छैन </h3>
