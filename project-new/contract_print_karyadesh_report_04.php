...
$data3   =  Contractmoredetails::find_by_plan_id($_GET['id']);
$data4_1 =  Contracttimeadditionaffiliation::maxPeriodForPlan($_GET['id']);


if(isset($_POST['submit']))
{
    $max_id=$_POST['max_id'];
    $data4=  Contracttimeadditionaffiliation::find_by_max($max_id,$_GET['id']);
...
<body>
    ...
    <div id="body_wrap_inner"> 
                ...
                <div class="maincontent">
                    <form method="get" action="contract_print_karyadesh_report_04_final.php?>">
                    <h2 class="headinguserprofile">विषय:- म्याद थप सम्बन्धमा । <a class="btn" href="contract_letter_dashboard.php"> पछी  जानुहोस </a>
										...
										<?php if($data4->period==1)
 {
     ...
     if($data4->period==6)
    {
		...
		?>								<div class="banktextdetails">
                    यस कार्यालयको स्वीकृत वार्षिक कार्यक्रम अनुसार <?php echo SITE_LOCATION;?> वडा नं.<?php echo convertedcit($data1->ward_no);?><!--(योजनाको ठेगाना भएको वडा न)--> मा <b><u><?php echo $data1->program_name; ?></u></b><!--(योजनाको नाम) --> 
                                                                                          योजना स्वीकृत भइ मिती <?php echo convertedcit($data3->miti);?><!--(योजना संझौताको मिति) --> 
                                                                                          मा यस गाँउपालिकासँग भएको संझौता अनुसार उक्त योजना मिति <?php echo convertedcit($data3->start_date);?><!--(योजना शुरु हुने मिति)--> देखी काम सुरु गरी मिती <?php echo convertedcit($data3->completion_date);?><!--(योजना सम्पन्न हुने मिति)--> भित्रमा  काम
                                                                                          सम्पन्न गर्ने गरी <?php echo $contractor_details->contractor_name;?> सँग सम्झौता गरी योजनाको कार्यदेश दिइएकोमा  <?php echo $contractor_details->contractor_name;?>ले मिति <?php echo convertedcit($data4->letter_date);?><!--(म्याद थपको लागी उपभोक्ता समितिले निबेदन दिएको मिती)-->
