...
<body>
    ...
    <div id="body_wrap_inner"> 
                ...
                <div class="maincontent">
                    <h2 class="headinguserprofile">योजनाको अनुदानको किसिम | <a href="view_topic_area_agreement.php" class="btn">पछि जानुहोस</a></h2>
                    ...
                    <div class="OurContentFull">
                        ...
                        <div class="userprofiletable">
                        	<form method="POST" enctype="multipart/form-data">
                            	<div class="inputWrap">
                                	<h1>योजनाको अनुदानको किसिम  थप्नुहोस [+]</h1>
