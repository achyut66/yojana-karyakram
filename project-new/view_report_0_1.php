...
$final_plan_array0 = $counted_result['final_count_array'];

$final_plan_array1 = $counted_result['advance_count_array'];
$final_plan_array2 = $counted_result['analysis_count_array'];
$final_plan_array3 = $counted_result['more_detail_count_array'];

$new_array = array_merge($final_plan_array0,$final_plan_array1);
// print_r($final_plan_array0);
// exit;
//$final_plan_array = $final_plan_array0+$final_plan_array1+$final_plan_array2+$final_plan_array3;

print_r($final_plan_array);
if(!empty($final_plan_array0))
{
   $total_investment = Plandetails1::get_total_investment_by_plan_ids(implode(",",$final_plan_array0));
   $result =  Plandetails1::find_by_plan_id(implode(",",$final_plan_array0));
//   echo "<pre>";
//   echo count($result);
   //print_r($result);
}
