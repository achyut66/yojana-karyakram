...
if(isset($_POST['submit']))
{
   // echo "<pre>"; print_r($_POST); echo "</pre>"; exit;
    ...
    //error_reporting(1);
     if($_POST['update']==1)
     {
       $data = Costumerassociationdetails0::find_by_id($_POST['update_id']); 
       $delete_details = Costumerassociationdetails::find_by_plan_id($data->plan_id);
     ...
     $data->created_date=  DateNepToEng($_POST['created_date']);
     $tol_id = $data->save();
    ...
    echo alertBox("थप सफल ","enlist_usamiti.php");
}
  ...
  if(!empty($group_heading) || !empty($group_details))
    {
	 ...
	 if(empty($group_heading))
	  ...
	  {
	        $edited_date = DateEngToNep($group_heading->created_date);
	  }
    ...
    <div id="body_wrap_inner"> 
        ...
        <div class="maincontent">
            ...
            <div class="OurContentFull">
				...
				<h2 class="headinguserprofile">योजना संचालन गर्ने उपभोक्ता समिति सम्बन्धी विवरण | <a href="settings.php" class="btn">पछि जानुहोस</a></h2>
                     ...
                     <div>
                            <form method="post" enctype="multipart/form_data">
                                ...
                                <div class="inputWrap50">
                                    <div class="titleInput">योजना दर्ता नम्बर :</div>
                                    <div class="newInput"><input id="getuname" class="form-control" type="number" name="plan_id" value="<?=$group_heading->plan_id?>"  class="input100percent" /></div>
                                    <div class="titleInput" ><b><span id="showuname"> </span></b></div>
                                    <div class="titleInput">योजना  संचालन गर्ने उपभोक्ता समितिको नाम:</div>
                                    ...
                                    <div class="titleInput">योजना  संचालन गर्ने उपभोक्ता समितिको ठेगाना: <span class="underline"><?php echo SITE_LOCATION;?> </span></div>
                                ...
                                <div class="titleInput">मिती:</div>
                                    <div class="newInput"><input type="text" name="created_date" value="<?=$edited_date ?>"  class="input100percent" id="nepaliDate3"/></div>
