...
if (isset($_POST['submit'])) {
    ...
    if ($program->savePostData($_POST)) {
        $session->message("पेश्की फर्छयौट तथा भुक्तानी सच्याउन सफल");
...
?>
<!-- js ends -->
<title>पेश्की फर्छयौट तथा भुक्तानी  सच्याउन :: <?php echo SITE_SUBHEADING;?></title>
</head>
<body>
        ...
        <div class="">
            <div class="">
                <div class="maincontent">
                    <h2 class="headinguserprofile">पेश्की फर्छयौट तथा भुक्तानी  सच्याउन</h2>
