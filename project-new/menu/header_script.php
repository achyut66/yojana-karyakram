...
function myFunction() {
   ...
   document.getElementById("demo").innerHTML = "<img src=\"images/wrong.png\" style=\" width:20px; height:20px;\">";
    }
    else{
        document.getElementById("demo").innerHTML = "<img src=\"images/right.png\" style=\" width:20px; height:20px;\">";
    }
}
</script>