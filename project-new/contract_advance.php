...
//    print_r($_POST);exit;
        ...
        {
          $data4 = Contractstartingfund::find_by_id($_POST['create_id']);
        }
        else
        {
        ...
        redirect_to("contract_advance.php");
 
}

 $value = "सेभ गर्नुहोस";
 $plan_selected = Plandetails1::find_by_id($_GET['id']);
 $data = Contractstartingfund::find_by_plan_id($_GET['id']);
 
 if(empty($data))
 {
  $data = Contractstartingfund::setEmptyObjects();
            ...
            <div class="OurContentFull">
                ...
                <div class="userprofiletable">
                     <div>
                        ...
                        <input type="submit" name="submit" value="<?php echo $value; ?>" class="submithere">
