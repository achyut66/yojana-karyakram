...
if (isset($_POST['submit'])) 
{
    ...
    empty($update_id)? $program =  new Programpaymentdetails : $program = Programpaymentdetails::find_by_id($update_id);
    ...
    if ($program->savePostData($_POST)) {
        ...
        redirect_to("program_payment_details.php?id=".$program_id);
    }
}

$program_payment_details= Programpaymentdetails::find_by_program_id($program_id);
if(empty($program_payment_details))
  {
      $program_payment_details = Programpaymentdetails::setEmptyObjects();
