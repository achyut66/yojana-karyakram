...
<div class="ourHeader">';$output.= $ward.$name.$topic." अनुसार " ;$output.='चौमासिक खर्च रिपोर्ट हेर्नुहोस </div>';
                                if($_GET['type']==0 && $_GET['format']==1){  
                 $output.=' <table class="table table-bordered table-responsive table-hover">
                                            <tr class="title_wrap">
                                                    <td>क्र.सं.</td>
                                            ...
                                            $i=1; foreach($topic_result as $topic){
                               ...
                               elseif($_GET['type']==0 && $_GET['format']==2){
                                  $output.='table class="table table-bordered table-responsive table-hover">
                                            <tr class="title_wrap">
                                             ...
                                             $i=1; foreach($budget_result as $topic){
...
//                                               echo $total_investment;exit;
            ...
            header("Content-Disposition: application; filename=chaumasik_report.xls");
            echo $output;
	?>	