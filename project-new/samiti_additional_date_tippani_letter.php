    	...
    	<div class="">
            <div class="">
                <div class="maincontent">
                    <form method="get" action="samiti_additional_date_tippani_letter_final.php?>">
...
?>
                    ...
                    <?php if(isset($_POST['submit'])):?>
                            ...
                            <!--<input type="hidden" name="max_id" value="<?=$max_id?>" /><input type="submit" value="प्रिन्ट गर्नुहोस" name="submit" /></div>-->
