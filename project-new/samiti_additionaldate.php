...
if(isset($_POST['submit']))
{
        ...
        $data = new Samitiplantimeadditionaffiliation;
...
$total_period = Samitiplantimeadditionaffiliation::maxPeriodForPlan($_GET['id']);
                ...
                <div class="userprofiletable">
                     ...
                     <div>
                                  ...
                                  for($i=1; $i<=$total_period; $i++): 
                                        $period_data = Samitiplantimeadditionaffiliation::find_by_plan_period($i,$_GET['id']);
                                ...
                                <div class="mycontent">
                                 <form method="post" >
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $more_plan_details->yojana_sakine_date; ?></td>
                                    </tr>
