...
<body>
    ...
    <div id="body_wrap_inner"> 
        <div class="maincontent">
            <h2 class="headinguserprofile">उपभोक्ता समिति मार्फत सम्झौता भएका योजनाहरु | <a href="sanchalan_prakriya_report.php" class="btn">पछि जानुहोस</a> |<a target="_blank" href="thekka_samjhauta_report_print.php" class="btn">Print</a></h2>
