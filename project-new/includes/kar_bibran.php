...
class Kar_Bibran
{
	protected static $table_name = "kar_bibaran";
	protected static $db_fields = array('id','darta_id','kar_percent','kar_rakam','total_kar_amount','kar_topic');
	public $id;
	public $darta_id;
	public $kar_percent;
	public $kar_rakam;
	public $total_kar_amount;
	public $kar_topic;
