...
class AnugamanSamitiBibaran
{
	protected static $table_name = "anugaman_samiti_bibaran";
	protected static $db_fields = array('id','post_id','name','address','gender','post_name','mobile_no','created_date');
