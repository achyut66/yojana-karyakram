...
class LetterBill
{
        protected static $table_name = "letter_bill_paper_details";
	    protected static $db_fields = array('id','plan_id','documents','date');
    	    public $id;
            public $plan_id;
            public $documents;
            public $date;
	...
	public static function find_all()
	{
        ...
        public static function SetEmptyObj()
	{
		global $database;
                $res= new self();
                return $res;
	...
	{
		global $database;
		$result_array=self::find_by_sql("select * from ".self::$table_name. " where plan_id={$id} order by id desc limit 1");
		return !empty($result_array)? array_shift($result_array) : false;
	}
