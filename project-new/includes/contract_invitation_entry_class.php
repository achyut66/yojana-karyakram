...
class Contractinvitationentry
{
	protected static $table_name = " contract_invitation_entry";
	protected static $db_fields = array('id','bid_id','contract_darta_miti','contractor_id','contractor_address','darta_miti','darta_miti_english','contractor_contact','plan_id');
        public $id;
        public $bid_id;
