...
class DharautiKhata
{
  protected static $table_name = "dharauti_khata_info";
  protected static $db_fields = array('id','plan_id','bank_name',
            'bank_address','bank_amount','bank_date','dharauti_amt','dharauti_miti');
