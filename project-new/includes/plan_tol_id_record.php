...
class PlanTolId
{
        protected static $table_name = "plan_tol_record";
	protected static $db_fields = array('id','tol_id','plan_id');
	public $id;
	public $tol_id;
        public $plan_id;
	...
	public static function find_by_plan_id($pan_no=0)
	{
		global $database;
		$result_array=self::find_by_sql("select * from ".self::$table_name. " where plan_id={$pan_no} limit 1");
		return !empty($result_array)? array_shift($result_array) : false;
	}
