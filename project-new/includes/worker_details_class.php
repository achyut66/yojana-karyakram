...
class Workerdetails
{
            protected static $table_name = "worker_details";
	protected static $db_fields = array('id','post_name','authority_name','authority_ward_no','status');
        public $id;
        public $post_name;
        public $authority_name;
        public $authority_ward_no;
        public $status;
        ...
        public function getName($string_id="")
            {
                     ...
                     return $topic_names = $topic_selected->authority_name;   
            }
	 public function getPost($string_id="")
            {
            
                     $topic_selected = self::find_by_id($string_id);
                     return $topic_names = $topic_selected->post_name;   
            }
	public static function setEmptyObject()
	{
	    $self  = new self;
	    return $self;
	}
