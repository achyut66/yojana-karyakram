...
class Contract_total_investment
{
	protected static $table_name = "contract_total_investment";
	protected static $db_fields = array('id','agreement_gaupalika','contract_total_amount','total_investment','bhuktani_anudan','plan_id','unit_id','unit_total','created_date','contractor_id');
        public $id;
	public $agreement_gaupalika ;
        public $contract_total_amount ;
