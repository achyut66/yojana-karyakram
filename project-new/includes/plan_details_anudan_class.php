...
class PlanDetailsAnudan
{
    protected static $table_name = "plan_details_anudan";
    protected static $db_fields = array('id','plan_id','is_contingency','title','value','is_marmat','is_anudan_add');
    public $id;
    public $plan_id;
    public $is_contingency;
    public $title;
    public $value;
    public $is_marmat;
    public $is_anudan_add;
    ...
    public static function find_by_type($type)
    {
        ...
        !empty($result_array)? $result = array_shift($result_array) : false;
