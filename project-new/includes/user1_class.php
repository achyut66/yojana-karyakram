...
{
	protected static $table_name = "user1";
	protected static $db_fields = array('id','name','phone','status','ward','email'
            ,'topic_area_id','topic_area_type_id','mode','ward_add','username','password');
        public $id;
        public $username;
        public $password;
        public $name;
...
//			echo mysqli_error($con);exit;
	...
	{
		global $database;
		return self::find_by_sql("select * from user1 ");
