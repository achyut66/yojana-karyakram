...
class Samitiprofitablefamilydetails
{
	protected static $table_name = "samiti_profitable_family_details";
	protected static $db_fields = array('id','pariwar_population','appangata','childrens','older_people','aanya','female'
            ,'male','other','total','type','total1','plan_id','created_date');
       public $id;
...
// Common database method
	...
	{
		$result_array=self::find_by_sql("select * from ".self::$table_name. " where type={$type} and plan_id={$plan_id} limit 1 ");
