...
class Quotationenlist
{
	protected static $table_name = " quotation_enlist_form";
	protected static $db_fields = array('id','plan_id','enlist_id','enlist_type','amount','extra_amount','is_vat','remarks');
		public $id;
		public $plan_id;
        public $enlist_id;
        public $enlist_type;
