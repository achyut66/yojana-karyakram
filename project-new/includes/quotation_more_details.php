...
class Quotationmoredetails
{
	protected static $table_name = "quotation_more_details";
	protected static $db_fields = array('id','yojana_start_date','yojana_end_date','yojana_place','miti','samjhauta_party','post_id_3','plan_id');
	public $id;
