...
class Quotationtotalinvestment
{
	protected static $table_name = "quotation_total_investment";
	protected static $db_fields = array('id','plan_id','gaupalika_anudan','contigency_amount',
            'kul_lagat_anudan','unit_id','unit_total');
        public $id;
		public $plan_id;
        public $gaupalika_anudan;
        public $contigency_amount;
        public $kul_lagat_anudan;
        public $unit_id;
        public $unit_total;
