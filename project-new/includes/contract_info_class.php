...
class Contractinfo
{
	protected static $table_name = " contract_info";
	protected static $db_fields = array('id','contract_amount','created_date','thekka_id','created_date_english','contract_type','last_entry_date','last_entry_date_english','amount','plan_id','ps');
        public $id;
        public $amount;
        ...
        public $last_entry_date_english;
        public $ps;
        public $thekka_id;
