...
class Samitiplanstartingfund
{
	protected static $table_name = "samiti_plan_starting_fund";
	protected static $db_fields = array('id','advance','advance_taken_date','advance_taken_date_english','advance_return_date_english','advance_taken_group','advance_taken_group_address','advance_return_date','advance_reason','plan_id','created_date');
	public $id;
	public $advance ;
        public $advance_taken_date ;
        public $advance_taken_date_english ;
        public $advance_taken_group ;
        public $advance_taken_group_address ;
        public $advance_return_date ;
         public $advance_return_date_english ;
        public $advance_reason;
        public $created_date;
        public $plan_id;
       	...
       	public static function setEmptyObjects()
	{
		...
		return $obj;
         ...
         public function getAdvanceAmount($plan_id)
            {
            
                     $topic_selected = self::find_by_plan_id($plan_id);
                     return $topic_names = $topic_selected->advance;   
            }
