...
class Materialanudan
{
	protected static $table_name = "material_anudan";
	protected static $db_fields = array('id','external_source','state_gov','local_level','sub_gov','foreign_gov','other_nikaya','plan_id');
	public $id;
