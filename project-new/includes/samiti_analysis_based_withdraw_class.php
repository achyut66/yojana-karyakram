...
class Samitianalysisbasedwithdraw
{
	protected static $table_name = "samiti_analysis_based_withdraw";
	protected static $db_fields = array('id','payment_evaluation_count','evaluated_date','evaluated_date_english','evaluated_amount','payable_amount','advance_payment','contengency_amount','renovate_amount','due_amount',
            'disaster_management_amount','total_amount_deducted','total_paid_amount','plan_id');
		public $id;
