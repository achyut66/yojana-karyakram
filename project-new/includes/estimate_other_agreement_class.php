...
class Estimateotheragreement
{
	protected static $table_name = "estimate_other_agreement";
	protected static $db_fields = array('id','total_investment_amount','other_investment','total_amount','plan_id');
	public $id;
	public $total_investment_amount;
