...
class Samitimoreplandetails
{
	protected static $table_name = "samiti_more_plan_details";
	protected static $db_fields = array('id','post_id_3','samiti_gathan_date','samiti_gathan_date_english','costumer_total_population',
            'yojana_start_date','yojana_start_date_english','yojana_sakine_date','yojana_sakine_date_english','samjhauta_party','miti','miti_english','plan_id');
	public $id;
	public $post_id_3 ;
        public $samiti_gathan_date ;
        public $samiti_gathan_date_english ;
        public $costumer_total_population ;
        public $yojana_start_date ;
        public $yojana_start_date_english;
        public $yojana_sakine_date ;
        public $yojana_sakine_date_english; 
        public $samjhauta_party;
        public $miti;
        public $miti_english;
        public $plan_id;
