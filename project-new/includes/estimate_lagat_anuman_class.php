...
class Estimatelagatanuman
{
	protected static $table_name = "estimate_lagat_anuman";
	protected static $db_fields = array('id','task_id','main_work_name','total_evaluation','unit_id','task_rate','total_rate','plan_id','break_type','sno');
	public $id;
	public $task_id;
	...
	public static function find_by_plan_id($id=0)
	{
        ...
        public static function find_by_plan_id_sno($id=0,$sno=0)
	{
		global $database;
		$result_array=self::find_by_sql("select * from ".self::$table_name. " where plan_id={$id} and sno={$sno} limit 1");
