...
class Contractinvitationforbid
{
	protected static $table_name = " contract_invitation_for_bid";
	protected static $db_fields = array('id','bid_id','contractor_id','contractor_address','contractor_contact','document_type','contractor_document','bill_no','bid_fee','contract_date','contract_date_english','plan_id');
        public $id;
        public $bid_id;
        ...
        public $contractor_document;
        public $bill_no;
        public $bid_fee;
        public $contract_date;
        public $contract_date_english;
        public $plan_id;
	...
	public static function getMaxbid($plan_id=0)
	{
		global $database;
		$sql = "select max(bid_id) from ".self::$table_name." where plan_id={$plan_id}";
		$result_set = $database->query($sql);
		$row = $database->fetch_array($result_set);
		return array_shift($row);
	}
