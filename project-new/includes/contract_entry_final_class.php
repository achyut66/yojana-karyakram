...
class Contractentryfinal
{
	protected static $table_name = " contract_entry_final";
	protected static $db_fields = array('id','contractor_id','bill_type','bid_amount','total_bid_amount','created_date','created_date_english','status','approved_date','approved_date_english','plan_id');
        public $id;
        public $bill_type;
