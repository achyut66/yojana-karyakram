...
class Plandetails
{
	protected static $table_name = "plan_details";
	protected static $db_fields = array('id','sn','topic_area_id','topic_area_type_id','topic_area_agreement_id','topic_area_investment_id','topic_area_investment_source_id','program_name','ward_no','tole_name','investment_amount');
	public $id;
	public $topic_area_id ;
        public $topic_area_type_id ;
        public $topic_area_agreement_id ;
        public $topic_area_investment_id ;
        public $topic_area_investment_source_id ;
        public $program_name;
       public $sn;
        public $ward_no;
        public $tole_name;
