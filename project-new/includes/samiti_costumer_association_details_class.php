...
class Samiticostumerassociationdetails
{
	protected static $table_name = "samiti_costumer_association_details";
	protected static $db_fields = array('id','post_id','name','address','gender','cit_no','issued_district','mobile_no','plan_id','created_date');
		public $id;
		public $post_id ;
        public $name ;
        public $address ;
        ...
        public static function find_by_post_plan_id($id,$plan_id)
	{
		global $database;
		$result_array=self::find_by_sql("select * from ".self::$table_name. " where post_id=$id and plan_id=$plan_id limit 1");
