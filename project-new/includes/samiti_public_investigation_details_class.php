...
class Samitipublicinvestigationdetails
{
	protected static $table_name = "samiti_public_investigation_details";
	protected static $db_fields = array('id','survey_date','population','plan_id','survey_date_english','created_date');
	public $id;
	public $survey_date;
	public $survey_date_english;
        public $population ;
       public $plan_id;
       public $created_date;
