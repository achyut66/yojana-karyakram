...
class LetterIndices
{
    protected static $table_name = "letter_indices";
    protected static $db_fields = array('id', 'letter_index', 'letter_index_nepali', 'letter_table', 'table_property');
    public $id;
    public $letter_index;
    public $letter_index_nepali;
    public $letter_table;
    ...
    public static function find_by_table($table)
    {
        global $database;
        $result_array = self::find_by_sql("select * from " . self::$table_name . " where letter_table='" . $table . "'");
    ...
    public static function find_by_index($index)
    {
        global $database;
        $result_array = self::find_by_sql("select * from " . self::$table_name . " where letter_index='".$index."' limit 1");
        return !empty($result_array) ? array_shift($result_array) : false;
    }
