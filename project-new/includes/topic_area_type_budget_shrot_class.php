...
class TopicAreaTypeBudgetShrot
{
            protected static $table_name = "topic_area_type_budget_shrot";
	protected static $db_fields = array('id','shrot_id','budget','topic_area_id','topic_area_type_id');
	public $id;
	public $shrot_id;
        public $budget;
