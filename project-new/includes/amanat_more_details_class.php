...
class Amanat_more_details
{
	protected static $table_name = "amanat_more_details";
            protected static $db_fields = array('id','chalani_no','organizer_name','organizer_name_address','organizer_name_post','aadesh_per_post','place_to_organize',
            'yojana_start_date','yojana_start_date_english','yojana_samjhauta_date','yojana_sakine_date',
            'yojana_sakine_date_english','pariwar_population','male','female','total','plan_id');
		public $id;
		public $organizer_name;
        public $place_to_organize;
        public $pariwar_population;
        public $male;
        public $female;
        public $organizer_name_address;
        public $organizer_name_post;
        public $aadesh_per_post;
        public $chalani_no;
        public $yojana_samjhauta_date;
        public $total;
        public $yojana_start_date ;
        public $yojana_start_date_english;
