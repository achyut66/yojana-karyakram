...
class AnugamanPatra
{
	protected static $table_name = "anugaman_detail_patra";
	protected static $db_fields = array('id','plan_id','thek','anugaman','prabidhik',
            'hording','khata','samuday','kista','bhautik','udeshya','samasya','prayas','sujhab','sujhab1');
    	public $id;
    	public $thek ;
        public $anugaman ;
        public $prabidhik ;
