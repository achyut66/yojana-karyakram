...
class Estimateanudandetails
{
	protected static $table_name = "estimate_anudan_details";
	protected static $db_fields = array('id','investment_amount','other_source','samiti_investment','other_agreement','total_investment','plan_id');
	public $id;
	public $investment_amount ;
        public $other_source ;
        public $samiti_investment;
