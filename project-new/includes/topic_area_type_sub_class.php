...
class Topicareatypesub
{
	protected static $table_name = "topic_area_type_sub";
	protected static $db_fields = array('id','sn','topic_area_type_id','topic_area_type_sub');
	public $id;
	public $sn;
	public $topic_area_type_id;
    public $topic_area_type_sub;
    ...
    public static  function getName($string_id="")
            {
            
                     $topic_selected = self::find_by_id($string_id);
                     return $topic_names = $topic_selected->topic_area_type_sub;   
            }
	...
	public static function find_by_topic_area_type_id($id=0)
	{
		global $database;
		$result_array=self::find_by_sql("select * from ".self::$table_name. " where topic_area_type_id={$id} ");
		return $result_array;
	}
