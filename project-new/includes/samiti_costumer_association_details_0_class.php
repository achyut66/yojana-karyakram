...
class Samiticostumerassociationdetails0
{
	protected static $table_name = "samiti_costumer_association_details_0";
	protected static $db_fields = array('id','program_organizer_group_name','program_organizer_group_address','plan_id','created_date');
	public $id;
	public $program_organizer_group_name;
        public $program_organizer_group_address;
        public $created_date;
        public $plan_id ;
	...
	public function setEmptyObjects()
	{
		$obj = new self;
		return $obj; 
	}
