...
class Costumerassociationdetails0
{
	protected static $table_name = "costumer_association_details_0";
	protected static $db_fields = array('id','address_new','program_organizer_group_name','program_organizer_group_address','plan_id','created_date');
    	public $id;
