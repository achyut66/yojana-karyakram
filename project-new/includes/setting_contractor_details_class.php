...
{
            protected static $table_name = "contract_details";
	protected static $db_fields = array('id','contractor_name','contractor_address','contractor_contact','pan_no');
	public $id;
        ...
        public function getName($string_id="")
            {
                     ...
                     return $topic_names = $topic_selected->contractor_name;   
            }
