...
class Contingencyexenditure
{
	protected static $table_name = "contingency_exenditure";
	protected static $db_fields = array('id','payment_evaluation_count','contingency_amount','taken_date','taken_date_english','plan_id');
        public $id;
        public $payment_evaluation_count;
        public $contingency_amount;
        public $taken_date;
	...
	{
		global $database;
		$sql = "select sum(contingency_amount) from ".self::$table_name." where plan_id={$plan_id}";
//                echo $sql;exit;
