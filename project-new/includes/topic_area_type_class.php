...
class Topicareatype
{
	protected static $table_name = "topic_area_type";
	protected static $db_fields = array('id','sn','topic_area_id','topic_area_type','budget');
	public $id;
	public $sn;
	public $topic_area_id;
    public $topic_area_type;
    public $budget;
	 ...
	 public static function getName($string_id="")
            {
                     ...
                     return $topic_names = $topic_selected->topic_area_type;   
            }
	...
	public static function find_by_topic_area_id($id=0)
	{
		global $database;
		$result_array=self::find_by_sql("select * from ".self::$table_name. " where topic_area_id={$id} ");
		return $result_array;
	}
