...
class Programpaymentfinal
{
	...
	protected static $db_fields = array('id','sn','program_remaining_amount','paid_date','paid_date_english','total_payment_amount','payment_taken_amount','congentency_amount','maintainance_amount','deposit_amount','emergency_amount','total_amount','net_total_amount','program_id','enlist_id');
	public $id;
        public $sn;
