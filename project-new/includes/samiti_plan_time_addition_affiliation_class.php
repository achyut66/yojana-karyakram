...
class Samitiplantimeadditionaffiliation
{
	protected static $table_name = "Samiti_plan_time_addition_affiliation";
	protected static $db_fields = array('id','period','program_problem_reason','letter_date','letter_date_english',
            'decesion_date','decesion_date_english','extended_date','extended_date_english','plan_id');
	public $id;
	public $period ;
	...
	{
		global $database;
		$result_array=self::find_by_sql("select * from ".self::$table_name. " where plan_id={$plan_id}  limit 1");
		return !empty($result_array)? array_shift($result_array) : false;
	}
