...
class Contractdharautiadd
{
	protected static $table_name = "contract_dharuti_add";
	protected static $db_fields = array('id','payment_evaluation_count','contractor_name','contractor_id','dharauti_amount','taken_date','taken_date_english','plan_id');
        public $id;
        public $payment_evaluation_count;
        public $contractor_name;
        public $contractor_id;
        public $dharauti_amount;
        public $taken_date;
        public $taken_date_english;
        public $plan_id;
        
        // Common database method
        public static function getTotalPayableAmount($plan_id=0,$contractor_id)
	{
		global $database;
		$sql = "select sum(dharauti_amount) from ".self::$table_name." where plan_id={$plan_id} and contractor_id=".$contractor_id;
//                echo $sql;exit;
