...
class EstimateLagatProfile
{
	protected static $table_name = "estimate_lagat_profile";
	protected static $db_fields = array('id','sub_total','gaupalika_anudan','contingency','bhuktani_anudan',
            'public_anudan','vat_amount','overhead','grand_total','date_nepali','date_english','plan_id','type');

        public $id;
	    public $sub_total;
        public $gaupalika_anudan;
        public $contingency;
        public $bhuktani_anudan;
        public $public_anudan;
        public $vat_amount;
        public $overhead;
        public $grand_total;
        public $date_nepali;
