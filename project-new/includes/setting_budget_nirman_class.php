...
class SettignBudgetNirman
{
        protected static $table_name = "budget_nirman";
        protected static $db_fields = array('id','program_name','address','topic_id',
            'amount','status','ward_no','budget_id','topic_area_type_sub_id','topic_area_type_id');
        public $id;
        public $ward_no;
        public $program_name;
        public $address;
