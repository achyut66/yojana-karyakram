...
class Investigationassociationdetails
{
	protected static $table_name = "investigation_association_details";
	protected static $db_fields = array('id','post_id','name','address','gender','mobile_no','plan_id','created_date','post_name');
	public $id;
	public $post_id ;
        public $name ;
        public $address ;
