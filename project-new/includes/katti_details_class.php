...
class KattiDetails
{
        protected static $table_name = "katti_details";
	protected static $db_fields = array('id','plan_id','payment_count','created_date'
        ,'created_date_english','katti_id','katti_amount','type');
	public $id;
	public $plan_id;
