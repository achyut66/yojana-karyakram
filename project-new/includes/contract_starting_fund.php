...
class Contractstartingfund
{
	protected static $table_name = "contract_starting_fund";
	protected static $db_fields = array('id','advance','advance_taken_date','advance_taken_date_english','advance_return_date_english','advance_return_date','advance_reason','plan_id','created_date');
	public $id;
	public $advance ;
    ...
    $contract_starting_fund=new Contractstartingfund();
?>