...
class Planamountwithdrawdetails
{
	...
	protected static $db_fields = array('id','get_qty','other_kaifiyet','doc_name','get_unit_id','plan_end_date','plan_end_date_english','yojana_sakine_date','yojana_sakine_date_english','upabhokta_aproved_date',
            ...
            'plan_id','bank_acc','chalani_no','bank_lagat_date','us_bank_acc','us_bank_name','created_date','created_date_english','final_bhuktani_ghati_amount','agreement_other_calc','agreement_gauplaika_calc','other_agreement_calc','customer_agreement_calc');
       public $id;
       public $get_qty;
       public $get_unit_id;
