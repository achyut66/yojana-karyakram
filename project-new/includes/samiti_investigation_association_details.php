...
class Samitiinvestigationassociationdetails
{
	protected static $table_name = "samiti_investigation_association_details";
	protected static $db_fields = array('id','post_id','name','address','gender','mobile_no','plan_id','created_date');
	public $id;
	public $post_id ;
        public $name ;
        public $address ;
