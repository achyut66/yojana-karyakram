...
class TopicAreaBudgetShrot
{
            protected static $table_name = "topic_area_budget_shrot";
	protected static $db_fields = array('id','shrot_id','budget','topic_area_id');
	public $id;
	public $shrot_id;
        public $budget;
	...
	public static function find_by_topic_area_id($pan_no=0)
	{
		global $database;
		$result_array=self::find_by_sql("select * from ".self::$table_name. " where topic_area_id={$pan_no}");
		return$result_array;
	}
