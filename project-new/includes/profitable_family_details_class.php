...
class Profitablefamilydetails
{
	protected static $table_name = "profitable_family_details";
	protected static $db_fields = array('id','type','dalit_ghar','dalit_mahila','dalit_purush','aadhibasi_ghar','aadhibasi_mahila','aadhibasi_purush'
            ,'anya_ghar','anya_mahila','anya_purush','total','total1','total2','total6','kul1','kul2','kul3','plan_id');
       public $id;
       public $type;
       public $dalit_ghar;
       public $dalit_mahila;
       public $dalit_purush;
       public $aadhibasi_ghar;
       public $aadhibasi_mahila;
       public $aadhibasi_purush;
       public $anya_ghar;
       public $anya_mahila;
       public $anya_purush;
       public $total;
...
// Common database method
	...
	public static function find_by_type_id($type=0,$plan_id)
	{
	...
	public function delete()
	{
		...
		return ($database->affected_rows() == 1) ? true : false;
      	...
      	public function delete_by_plan_id()
	{
		global $database;
		// delete from table where condition limit 1
		$sql = "delete from " .self::$table_name ;
		$sql .= " where plan_id=".$database->escape_value($this->plan_id);
		$sql .= " limit 1";
		$database->query($sql);
		return ($database->affected_rows() == 1) ? true : false;
	}	
