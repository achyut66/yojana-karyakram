...
class Contract_bid
{
	protected static $table_name = "contract_bid";
	protected static $db_fields = array('id','bid_amount','enlist_id','status','plan_id');
        public $id;
	    public $bid_amount ;
        public $status ;
        public $plan_id;
	...
	public static function find_by_plan_id_and_status($plan_id,$status)
	{
		global $database;
		$result_array=self::find_by_sql("select * from ".self::$table_name. " where plan_id={$plan_id} and status=$status limit 1");
