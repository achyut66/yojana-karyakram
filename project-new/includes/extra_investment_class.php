...
class Extrainvestment
{
	protected static $table_name = "extra_investment_details";
	protected static $db_fields = array('id','budget_id','plan_id','amount','topic_id');
        public $id;
        public $budget_id;
        public $plan_id;
        public $amount;
    ...
    public static function find_by_plan_id_and_type_id($id=0,$type_id=0)
    {
        global $database;
        $result_array=self::find_by_sql("select * from ".self::$table_name. " where plan_id={$id} and type_id= {$type_id} limit 1");
