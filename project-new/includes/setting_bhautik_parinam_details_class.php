...
class SettingbhautikPariman
{
    protected static $table_name = "setting_bhautik_pariman";
    protected static $db_fields = array('id','name', 'parent_id');
    public $id;
    public $name;
    public $parent_id;
    ...
    {
        global $database;
        $sql = "select max(ward) from ".self::$table_name."";
    ...
    public static function find_all_parents()
    {
        global $database;
        return self::find_by_sql("select * from ".self::$table_name. " where parent_id=-1");

    }
    public static function find_child_by_parent($id)
    {
        global $database;
        return self::find_by_sql("select * from ".self::$table_name. " where parent_id='".$id."'");

    }
    public static function get_marmat_samhar_percent()
    {
