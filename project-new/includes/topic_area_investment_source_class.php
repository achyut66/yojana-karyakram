...
class Topicareainvestmentsource
{
	protected static $table_name = "topic_area_investment_source";
	protected static $db_fields = array('id','sn','name');
	public $id;
        public $sn;
	public $name;
	...
	public function getName($string_id=""){
                     ...
                     $item_selected = self::find_by_id($string_id);
                     return $topic_name = $item_selected->name ;
            }
