...
class NapiLagatAnuman
{
	...
	protected static $db_fields = array('id','task_id','task_name','task_count','length','breadth','height','total_evaluation','unit','task_rate','total_rate','period','plan_id');
	public $id;
	public $task_id ;
        public $task_name;
        public $task_count;
         ...
         public static function find_by_plan_id($id=0)
	{
        ...
        public static function find_by_plan_id_period_task_id_task_name($plan_id=0,$period,$task_id,$task_name)
	{
		global $database;
        ...
        public static function find_by_plan_id_period($id=0,$period)
	{
		global $database;
		$result_array=self::find_by_sql("select * from ".self::$table_name. " where plan_id={$id} and period={$period}");
		return $result_array;
	}
