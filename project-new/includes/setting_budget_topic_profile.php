...
class Topicbudgetprofile
{
        protected static $table_name = "topic_budget_profile";
	protected static $db_fields = array('id','budget_topic_id','fiscal_id','amount');
	public $id;
	public $budget_topic_id;
        public $fiscal_id;
        public $amount;
	...
	public static function find_by_budget_topic_id($budget_topic_id)
        {
                global $database;
		$result_array=self::find_by_sql("select * from ".self::$table_name. " where budget_topic_id={$budget_topic_id} limit 1");
		return !empty($result_array)? array_shift($result_array) : false;
        }
