...
class Samitiplanamountwithdrawdetails
{
	protected static $table_name = "samiti_plan_amount_withdraw_details";
	protected static $db_fields = array('id','plan_end_date','plan_end_date_english','yojana_sakine_date','yojana_sakine_date_english','upabhokta_aproved_date',
            ...
            'final_contengency_amount','final_renovate_amount','final_due_amount','final_disaster_management_amount','final_total_amount_deducted',
       ...
       public $plan_evaluated_date_english;
        ...
        // Common database method   
         ...
         public function get_payement_till_now($plan_id)
         {
             global $analysis;
