...
class SettingSpecs
{
	protected static $table_name = "settings_specification";
	protected static $db_fields = array('id','name','default_spec','enable','task_id');
	public $id;
	public $name;
        public $default_spec;
        public $enable;
        ...
        public function getName($string_id="")
            {
                     ...
                     return $topic_names = $topic_selected->task_name;   
            }
	...
	public static function find_by_id($id=0)
	{
        ...
        public static function find_enabled_specs($task_id=0)
	{
		global $database;
		$result_array = self::find_by_sql("select * from ".self::$table_name. " where task_id={$tak_id} and enable=1");
		return $result_array;
	}
        
        public static function find_default_specs($task_id=0)
	{
		global $database;
		$result_array = self::find_by_sql("select * from ".self::$table_name. " where task_id={$task_id} and default_spec=1");
		return $result_array;
	}
	public static function find_by_task_id($task_id=0)
	{
		global $database;
		$result_array = self::find_by_sql("select * from ".self::$table_name. " where task_id={$task_id}");
		return $result_array;
	}
