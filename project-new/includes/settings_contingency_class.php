...
class Contingency 
{
        protected static $table_name = "contingency";
	protected static $db_fields = array('id','percent','amount','plan_id','type');
	public $id;
        public $percent;
	public $amount;
        public $plan_id;
	...
	{
		global $database;
		$result_array=self::find_by_sql("select * from ".self::$table_name. " where plan_id={$plan_id}");
               !empty($result_array)? $result = array_shift($result_array) : false;
               return $result->amount;
	}
