...
class Contractbidfinal
{
	protected static $table_name = " contract_bid_final";
	protected static $db_fields = array('id','contractor_id','bank_name','bank_address','bank_guarentee','bank_guarentee_date','dharauti_amount','details','created_date','created_date_english','plan_id');
        public $id;
        public $contractor_id;
        public $bank_name;
        public $bank_address;
        public $bank_guarentee_date;
        public $bank_guarentee;
        ...
        // Common database method
            public static function find_by_max_contractor_id($plan_id)
            {
                   global $database;
                    $sql="select max(contractor_id) from ".self::$table_name. " where plan_id=".$plan_id;
                    $result_set = $database->query($sql);
                    $row = $database->fetch_array($result_set);
                    return array_shift($row);
            }
        public static function find_by_contractor_id($contractor_id,$plan_id)
	{
		global $database;
