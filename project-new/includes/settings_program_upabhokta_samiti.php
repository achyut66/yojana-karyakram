...
class Upabhoktasamitiprofile
{
	protected static $table_name = "settings_program_upabhokta_samiti";
	protected static $db_fields = array('id','program_organizer_group_name','program_organizer_group_address','created_date','created_date_english');
	public $id;
