...
class NapiLagatProfile
{
	protected static $table_name = "napi_lagat_profile";
	protected static $db_fields = array('id','date_english','date_nepali','plan_id','period','sub_total','antim');
	...
	public static function find_by_id($id=0)
	{
        ...
        public static function find_by_plan_id($plan_id=0)
	{
		global $database;
        ...
        public static function find_max_period($plan_id=0)
	{
        ...
        public static function find_next_period($plan_id=0)
	{
		global $database;
		$sql = "select max(period) from ".self::$table_name." where plan_id=".$plan_id;
		$result_set = $database->query($sql);
