...
class Programmoredetails
{
	...
	protected static $db_fields = array('id','sn','budget','remaining_budget','work_name','work_order_date','work_order_budget','start_date','start_date_english','completion_date','completion_date_english','venue','enlist_id','type_id','total_family_members','male','female','total_members','worker_id','samjhauta_miti','program_id');
	public $id;
        public $sn;
        public $budget;
