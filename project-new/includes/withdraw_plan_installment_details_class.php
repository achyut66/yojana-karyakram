...
class Withdrawplaninstallmentdetails
{
	protected static $table_name = "Withdraw_plan_installment_details";
	protected static $db_fields = array('id','first_installment','second_installment','third_installment','fourth_installment','last_installment','plan_id');
	public $id;
	public $first_installment ;
        public $second_installment ;
        public $third_installment ;
        public $fourth_installment ;
        public $last_installment ;
        public $plan_id;
