    ...
    <div class="myPrintFinal" > 
    	<div class="userprofiletable">
			...
			<div class="banktextdetails1 ">
                            <div class="subject myFont1">ठेक्का संझौता फाराम</div>
                            <div class="banktextdetails1">
                     ...
                     <table class="table-bordered myWidth100 myFont1">
                                      ...
                                      <tr>
                                          ...
                                          <tr>
                                               <td>योजनाको विनियोजन किसिम : </td><td><?php echo Topicareainvestment::getName($data->topic_area_investment_id    ); ?></td>
                                          </tr>
                            ...
                            <h3 class="myheader" style="text-align: center; font-size: 15px; font-weight: bold; padding: 10px;">ठेक्का संचालन विवरण </h3>
                          <div class="mycontent" >
                          ...
                          <h3 class="myheader" style="text-align: center; font-size: 15px; font-weight: bold; padding: 10px;"> योजनाबाट लाभान्वित घरधुरी तथा परिबारको विबरण</h3>
                            <div class="mycontent" >
                          <table class="table table-bordered">
                            <tr>
...
<div class="myFont2">                                              
<ul>
                                                 <h4 style="text-align: center; font-size: 15px; font-weight: bold; padding: 10px;">सम्झौताका शर्तहरु</h4>
                                                 <ol class="mylist" style="list-style-type: circle;">
                                                     <li style="padding: 5px;"><b><?php echo $plan_selected->program_name;?> </b>योजनाको काम सम्पन्न भएपछि पहिलो पक्षले दोश्रो पक्षलाई जम्मा रु ‍<?php echo convertedcit(placeholder($contract_ti->contract_total_amount));?> अक्षरुपी <?php echo convert($contract_ti->contract_total_amount);?> मात्र भुत्तानी दिनेछ ।</li>
                                                <li style="padding: 5px;"><b><?php echo $plan_selected->program_name;?></b> योजना मिति <?php echo convertedcit($worker->start_date);?>देखि शुरु गरी मिति <?php echo convertedcit($worker->completion_date);?> सम्ममा पुरा गर्नु पर्नेछ ।</li>
                                                <li style="padding: 5px;">दोश्रो पक्षले निर्माणकार्य गर्दा लाग्ने सम्पुण गुणस्तरिय समानहरुको प्रयोग प्राबिधिकबाट जचाँएर मात्र प्रयोग गर्नु पर्नेछ ।</li>
                                                <li style="padding: 5px;">दोश्रो पक्षले काम सम्पन्न भएपछि फाईनल विल र कार्यसम्पन्न प्रतिबेदन  वा रनिङ विलको आधारमा मात्र पहिलो पक्षले भुक्तानी दिनेछ ।</li>
                                                <li style="padding: 5px;">दोश्रो पक्षले निर्माण कार्यमा बाल श्रमिकको प्रयोग गर्न पाईने छैन ।</li>
                                                <li style="padding: 5px;">यस संझौता अबधिमा काममा कुनै समस्या उत्पन्न भएमा दुबै पक्षको सहमितमा समाधान गरिने छ ।</li>
                                                <li style="padding: 5px;">दोश्रो पक्षले काममा पेशकी माग गरेमा बैंक ग्यारेन्टी पेश गरेपछि मात्र भ्याट बाहेकको रकमको २० प्रतिशत सम्म पहिलो पक्षले उपलब्ध गराउने छ ।</li>
                                                <li style="padding: 5px;">पेश्की लिएर लामो समयसम्म योजना संचालन नभएमा कार्यालयले नियम अनुसार कारवाही गर्नेछ ।</li>
                                                <li style="padding: 5px;">यस संझौतामा उल्लेख नभएका कुराहरु प्रचलित कानून वमोजिम हुनेछ ।</li>
                                                <?php  if(!empty($final_result)):
                                                    foreach($final_result as $data):?>
                                                     <li> <?=$data->rule?> </li>
                                                    <?php  endforeach;endif;?>
                                            </ol><!-- samjhauta list ends -->
                                              <div class="subject myFont1">माथि उल्लेख भए बमोजिमका शर्तहरु पालना गर्न हामी निम्न पक्षहरु मन्जुर गर्दछौं ।</div>
                                             <h4 style="text-align: center; font-size: 15px; font-weight: bold; padding: 10px;">ठेकदारको तर्फबाट </h4>
                                              <div class="mycontent">
                                              ...
                                              <h4 style="text-align: center; font-size: 15px; font-weight: bold; padding: 10px;">स्थानीय तहको तर्फबाट</h4>
                                              <div class="mycontent">
                                              	<table class="table table-bordered">
                                                	<tr>
