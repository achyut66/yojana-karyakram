...
if(isset($_POST['submit']))
{
        ...
        $data = new Programtimeadditionaffiliation;
        $data->sn = $_POST['sn'];
        ...
        $data->save();
        echo alertBox(" म्याद थप सफल","program_additional_date.php");
}
if(isset($_GET['sn']))
{
    $enlist_selected= Programmoredetails::find_by_program_id_and_sn($_GET['id'],$_GET['sn']);
   
    $value = "सेभ गर्नुहोस";
	
	 $more_plan_details = Moreplandetails::find_by_plan_id($_GET['id']);
	$total_period = Programtimeadditionaffiliation::maxPeriodForProgram($_GET['id'],$_GET['sn']);
...
<div class="">
    <div class="">
        <div class="maincontent">
            <h2 class="headinguserprofile"><?=$plan_selected->program_name?> /<a href="program_dashboard.php?id=<?= $_SESSION['set_plan_id'] ?>" class="btn">पछी जानुहोस </a></a></h2>
            ...
            <div class="OurContentFull">
                ...
                <div class="userprofiletable">
                     ...
                     <div>
                                    <h3>कार्यक्रमको म्याद थप सम्बन्धी बिषेश व्यबस्था</h3>
                                    <form method="get">
                                    ...
                                    <tr>
                                        <td>कार्यदेश नं:</td>
                                         ...
                                         <td>
                                             <select class="sn1" name="sn" onchange="form.submit();">
                            ...
                            <?php if(isset($_GET['sn'])): ?>
                                  ...
                                  for($i=1; $i<=$total_period; $i++): 
                                        $period_data = Programtimeadditionaffiliation::find_by_program_period($i,$_GET['id']);
                            ...
                            <div class="mycontent"  style="display:none;">
                             <table class="table table-bordered table-responsive">
                               <tr>
                                    <td>कार्यदेश नं:</td>
                                    <td><?= convertedcit($period_data->sn) ?></td>
                                  </tr>         
                              <tr>
                                    <td>अवधि</td>
                                    <td><?=$inst_array[$i]?></td>
                                  ...
                                  <tr>
                                    <td>कार्यक्रम म्याद भित्र नसकिनुको कारण</td>
                                    <td><?=$period_data->program_problem_reason?></td>
                                  </tr>
                                  <tr>
                                    <td>म्याद थपको लागी निबेदन दिएको मिती</td>
                                    <td><?=convertedcit($period_data->letter_date)?></td>
                                  </tr>
                                  <tr>
                                    <td>म्याद थपको कार्यालयबाट निर्णय भएको मिती</td>
                                    <td><?=convertedcit($period_data->decesion_date)?></td>
                                  </tr>
                                  <tr>
                                    <td>थपिएको म्यादको अबधी</td>
                                    <td><?= convertedcit($period_data->extended_date)?></td>
                                  </tr>
                       </table>
                     </div>
                         <?php endfor; ?>        
                                 ...
                                 <form method="post" >
                                    ...
                                    <tr>
                                     ...
                                     <tr class="enlist2">
                                         ...
                                         <td>
                                             <?php 
                                               if($enlist_selected->type_id==5)
                                                {
                                                  $u_samiti = Upabhoktasamitiprofile::find_by_id($enlist_selected->enlist_id);
                                                  echo $u_samiti->program_organizer_group_name;   
                                                }
                                               else
                                                {
                                                  echo  Enlist::getName1($enlist_selected->enlist_id);
                                                }
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo convertedcit($enlist_selected->completion_date); ?></td>
                                    </tr>
                                    <?php if(!empty($extended_date)): ?>
                                    <tr>
                                        <td>म्याद थप भइ पुन: तोकिएको सम्पन्न मिति</td>
                                        <td><?php echo convertedcit($extended_date); ?></td>
                                    </tr>
                                    <?php endif; ?>
                                  <tr>
                                    <td>अवधि</td>
