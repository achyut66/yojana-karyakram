...
if(isset($_POST['submit']))
{
    for($i=0;$i<count($_POST['approve']);$i++)
    {
        ...
        echo alertBox("डाटा स्वीकृत  भयो ||", "budget_nirman_approve.php");
}
...
{
$budget_nirman_result = SettignBudgetNirman::find_by_sql("select * from budget_nirman where status=0 and ward_no=".$_GET['ward']);
}
else
{
    $budget_nirman_result = SettignBudgetNirman::find_by_sql("select * from budget_nirman where status=0");
}
...
<body>
    ...
    <div id="body_wrap_inner"> 
    	<div class="maincontent">
             <h2 class="headinguserprofile">बजेट निर्माण स्वीकृत गर्नुहोस | <a href="index.php" class="btn">पछि जानुहोस </a></h2>
                    <div class="myMessage"><?php echo $message;?></div>
                    <div class="OurContentFull">
                       
                        <h2>बजेट निर्माण स्वीकृत गर्नुहोस </h2>
                        <form method="get" >
                            <div style="overflow-x:auto;">
                        <table class="table table-bordered table-responsive">
                                <tr>
                                    <td class="myCenter">वार्ड नं :<input type="text" name="ward" class="input100percent" value="<?php echo $search_ward;?>"/></td>
                                    <td class="myCenter"><input type="submit" name="submit" value="खोज्नुहोस" class="btn" /></td>
                                    <td class="myCenter"><a class="btn" href="budget_nirman_approve.php">रद्द गर्नुहोस </a></td>
                        	    ...
                        	    <div style="overflow-x:auto;">
                                    <table class="table table-bordered table-hover">
                                       ...
                                       <?php
                                        ...
                                        {
                                            echo "<h2><b>No Data To Show</b></h2>";
                                        }
                                        else
                                        {
                                             ...
                                             <td id="topic_area_type_sub_<?=$i?>">
                                                <select name="topic_area_type_sub_id[]" id="topic_area_type_sub_id_<?=$i?>" >
                                                   ...
                                                   <option value="<?php echo $topicd->id?>" <?php if($data->topic_area_type_sub_id==$topicd->id){ echo 'selected="selected"';}?>><?php echo $topicd->topic_area_type_sub;  ?></option>
                                                    ...
                                                    <td><teatarea type="text" name="amount[]" readonly="true"><?=$data->amount?></textarea></td>
                                                    <td><input type="checkbox" name="approve[]" value="<?=$data->id?>" checked="checked"</td>
                                                </tr>
...
<!--                            	<div class="inputWrap33 inputWrapLeft"><div class="add_nirman btn myWidth100">थप्नुहोस [+]</div></div>
                               ...
                               <?php  if(!empty($budget_nirman_result))
                                        {?>
                                <div class="inputWrap33 inputWrapLeft"><input type="submit" name="submit" value="स्वीकृत गर्नुहोस " class="submit btn myWidth100"></div><input type="hidden" name="update" value="<?=$update?>">
                            <?php } ?>
