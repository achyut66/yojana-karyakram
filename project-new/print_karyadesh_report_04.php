    	...
    	<div class="">
            <div class="">
                ...
                <?php if(!empty($program_payment)): ?>
                     ...
                     <form method="get" action="print_karyadesh_report_04_final.php?id=<?=$_GET['id']?>" target="_blank" >
                            ...
                            <input type="hidden" name="program_id" value="<?=$program_payment->id?>" />
                        	...
                        	<div class="printPage">
									...
									<div class="chalanino">चलानी नं: </div>
										...
										<div class="banktextdetails"  >
											यस कार्यालयको स्वीकृत बार्षिक कार्यक्रम अनुसार  तपशिलको विवरणमा उल्लेख बमोजिमको कार्यक्रम संचालन गर्न यस कार्यालयको मिति  <?= convertedcit($program_more_details->work_order_date) ?> को  निर्णय अनुसार मिति  <?= convertedcit($program_payment->payment_flow_date) ?> भित्रमा पेश्की फर्छयौट गर्ने गरी उक्त कार्यक्रम संचालनका लागी रु: <?= convertedcit(placeholder($program_payment->payment_amount)) ?> पेश्की उपलब्ध गराइको छ । तोकिएको समयमा काम सम्पन्न गरी कार्यक्रममा भएको यथार्थ खर्चको बिल,भरपाई,तथा कार्यक्रमको  फोटो सहित यस <?php echo SITE_TYPE;?>मा पेश गरी बाँकी रकम भुक्तानी लिनहुन जानकारी गराइन्छ । 
										</div>
