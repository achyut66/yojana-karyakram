...
//            echo '</pre>';exit;
            ?>
            <form method="get" action="print_quotation_kabol_karyadesh_final.php?id=<?= $_GET['id'] ?>" target="_blank">
                ...
                <div class="userprofiletable">
                    <div class="printPage">
                        ...
                        <div class="printContent">
                            ...
                            <div class="oursignatureleft mymarginright" style="margin-left:160px"> योजना शाखा <br/>
