...
<body>
    ...
    <div id="body_wrap_inner"> 
        ...
        <div class="maincontent">
            <h2 class="headinguserprofile">कुल योजनाको रिपोर्ट हेर्नुहोस | <a href="report.php" class="btn">पछि जानुहोस</a> | <a href="view_report0_excel.php?ward_no=<?=$_GET['ward_no']?>" class="btn">Excel Export</a> | <a target="_blank" href="view_report0_print.php?ward_no=<?=$_GET['ward_no']?>" class="btn">Print</a></h2>
            ...
            <div class="OurContentFull">
                ...
                <div class="userprofiletable">
				     <div class="myPrint"><a target="_blank" href="report0_print.php">प्रिन्ट गर्नुहोस</a></div><br>
