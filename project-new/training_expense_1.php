...
class TrainingExpense
{
	...
	protected static $db_fields = array('id','description','unit','rate','quantity','total','remarks','plan_id');
	public $id;
	public $description ;
        public $unit;
        public $rate;
	...
	public static function find_all()
	{
        ...
        public static function find_all_by_plan_id($plan_id)
	{
		global $database;
		return self::find_by_sql("select * from ".self::$table_name." where plan_id= {$plan_id}");
		 	
	}
        public static function find_grand_total_by_plan_id($plan_id)
	{
		global $database;
		$sql = "select sum(total) from ".self::$table_name." where plan_id = {$plan_id}";
