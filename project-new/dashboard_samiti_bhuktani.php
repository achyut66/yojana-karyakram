...
<body>
    ...
    <div id="body_wrap_inner"> 
        ...
        <div class="maincontent">
             <h2 class="dashboard">उपभोक्ता समिति मार्फत | <a href="yojanasanchalandash.php" class="btn">योजना संचालन प्रकृया</a> </h2>
            ...
            <div class="OurContentFull">
                ...
                <div class="userprofiletable">
                        ...
                        <?php endif;?>
                         ...
                         <a href="samiti_print_bank_report_14.php">
                        ...
                        <a href="samiti_print_bank_report_13.php"><div class="userprofile">
                        	<h3> मुल्यांकनको आधारमा  भुक्तानीको सिफारिस </h3>
                            <div class="dashimg">
                            	<img src="images/pen-icon.png" alt="Report Icons" class="dashimg" />
                            </div>
                        </div></a><!-- user profile ends -->
                        <a href="samiti_print_bank_report_12.php"><div class="userprofile">
                        	<h3>अन्तिम भुक्तानीको </br>सिफारिस </h3>
                            <div class="dashimg">
                            	<img src="images/pen-icon.png" alt="Report Icons" class="dashimg" />
                            </div>
                        </div></a><!-- user profile ends -->
