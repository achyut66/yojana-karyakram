        ...
        <h2 class="dashboard">ठेक्का  संचालन प्रकृया | <a href="contract_dashboard.php?id=<?= $program_id ?>" class="btn" >पछी जानुहोस </a></h2>
            <div class="OurContentFull">
                ...
                <div class="grid-container">
                    <a href="contract_print_karyadesh_report_09.php">
                        <div class="userprofile grid-item">
                        	<h4>ठेक्का सम्झौताको टिप्पणी </h4>
                            <div class="dashimg">
                            	<img src="images/pen-icon.png" alt="Report Icons" class="dashimg" />
                            </div>
                        </div></a><!-- user profile ends -->
               		  <a href="contract_print_karyadesh_report_08.php"> 
                      <div class="userprofile grid-item">
                        	<h4>ठेक्का संझौता पत्र</h4>
                            <div class="dashimg">
                            	<img src="images/pen-icon.png" alt="Report Icons" class="dashimg" />
                            </div>
                        </div></a><!-- user profile ends -->
                        <a href="contract_print_karyadesh_report_02.php">
                        <div class="userprofile grid-item">
                        	<h4>कार्यदेश पत्र</h4>
                            <div class="dashimg">
