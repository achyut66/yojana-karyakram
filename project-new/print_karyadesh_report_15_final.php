...
$program_payment= Programpayment::find_by_id($_GET['program_id']);
?>
...
<div class="printlogo"><img src="images/emblem_nepal.png" alt="Logo"></div>
             	<h1 class="marginright1 letter_title_one">बुढीगंगा गाउँपालिका</h1>
                    <h4 class="marginright1 letter_title_two"> गाउँ कार्यपालिकाको कार्यालय </h4>
                    <h5 class="marginright1 letter_title_three">मोरंग , १ नं. प्रदेश नेपाल </h5>
                    <div class="myspacer"></div>
									...
									<div class="chalanino">कार्यक्रम दर्ता नं : <?php echo convertedcit($_GET['id'])?></div>
										...
										<div class="subject">विषय:- पेस्की सम्बन्धमा ।</div>
										<div class="myspacer"></div>
										...
										<div class="banktextdetails"  >
											यस कार्यालयको स्वीकृत बार्षिक कार्यक्रम अनुसार  तपशिलको विवरणमा उल्लेख बमोजिमको कार्यक्रम संचालन गर्न यस कार्यालयको मिति  <?= convertedcit($program_more_details->work_order_date) ?> को  निर्णय अनुसार श्री <?= $name ?>संग भएको सम्झौता अनुसार मिति  <?= convertedcit($program_payment->payment_flow_date) ?> भित्रमा पेश्की फर्छयौट गर्ने गरी उक्त कार्यक्रम संचालनका लागी रु: <?= convertedcit(placeholder($program_payment->payment_amount)) ?> पेश्की उपलब्ध गराउन हुन अनुरोध छ ।  
										</div>
                                            ...
                                            <table class="table-bordered myWidth100">
                                                ...
                                                <tr>
                                                	<td>कार्यादेश नं : </td>
                                                    <td><?php echo  convertedcit(placeholder($program_more_details->sn));?></td>
                                                </tr>
                                                <tr>
