                            ...
                            <form method="POST" enctype="multipart/form-data">
                                <table class="table table-bordered">
                                    ...
                                    <tr>                                            
                                        ...
                                        <td><input type="text" class="work_name" name="work_name" value="<?php echo $program_more_details->work_name; ?>" /></td>
                                    </tr>
                                    <tr>                                            
                                        <td width="238">कार्यादेश दिईएको रकम रु</td>
                                        <td><input type="text" class="work_budget" name="work_order_budget" value="<?php echo $program_more_details->work_order_budget; ?>" /></td>
                                    </tr>
                                    <tr>                                           
