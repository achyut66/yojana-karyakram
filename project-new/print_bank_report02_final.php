                                          ...
                                          <tr>
                                           ...
                                           <tr>
                                            ...
                                            <table class="table-bordered myWidth100 myFont1">
                                                    ...
                                                    ?>
                                                     <tr>
                                                        <td class="myWidth50 myTextalignLeft">भौतिक ईकाईको  परिणाम : </td><td><?=convertedcit($data->unit_total)?> <?=$unit->name?></td>
                                                      <tr>
                                                    <?php
                                                ...
                                                <tr>
                                                    ...
                                                    <td>रु. <?php echo convertedcit($result->marmat_new);?></td>
                                                      ...
                                                      <td class="myTextalignLeft" ><?php echo SITE_TYPE;?>बाट अनुदान रकम : रु.  </td><td><?php echo convertedcit($data->agreement_gauplaika);?></td>
                                                    </tr>
                                                    <tr>
                                                      <td class="myTextalignLeft">अन्य निकायबाट प्राप्त अनुदान रकम : </td><td>रु. <?php echo convertedcit($data->agreement_other);?></td>
                                                    </tr>
                                                    <tr>
                                                      <td class="myTextalignLeft" >उपभोक्ताबाट नगद साझेदारी रकम : </td><td>रु. <?php echo convertedcit($data->costumer_agreement);?></td>
                                                    </tr>
                                                    <tr>
                                                      <td class="myTextalignLeft">अन्य साझेदारी रकम : </td><td>रु. <?php echo convertedcit($data->other_agreement);?></td>
                                                    </tr>
                                                    <tr>
                                                      <td class="myTextalignLeft">उपभोक्ताबाट जनश्रमदान रकम : </td><td>रु. <?php echo convertedcit($data->costumer_investment);?></td>
                                                    </tr>
                                                    <tr>
                                                      <td class="myTextalignLeft">कुल लागत अनुमान जम्मा  रकम : </td><td>रु. <?php echo convertedcit($data->total_investment);?></td>
                                                    </tr>
                                                  </table>
                                                </div>
...
?>
                                                 ...
                                                 <?php $i=1;foreach($data4 as $data):
                                                     if($data->gender==1){
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="myCenter"><?php echo SITE_NAME?> <?php echo convertedcit($data->address);?></td>
                                              ...
                                              <table class="table-bordered myWidth100 myFont1">
                                                      <?php $data= Moreplandetails::find_by_plan_id($_GET['id']); ?>
                                                      <tr>
                                                            <td class="myWidth50 myTextalignLeft">उपभोक्ता समिति गठन भएको मिति : </td><td><?php echo convertedcit($data->samiti_gathan_date);?></td>
                                                          </tr>
                                                          <tr>
                                                            <td class="myTextalignLeft">उपभोक्ता भेलामा उपस्थिति संख्या : </td><td><?php echo convertedcit($data->costumer_total_population);?></td>
                                                          </tr>
                                                          <tr>
                                                            <td class="myTextalignLeft">योजना शुरु हुने मिति : </td><td><?php echo convertedcit($data->yojana_start_date);?></td>
                                                          </tr>
                                                          <tr>
                                                            <td class="myTextalignLeft">योजना सम्पन्न हुने मिति : </td><td><?php echo convertedcit($data->yojana_sakine_date);?></td>
                                                          </tr>
                                                   </table>
                                         ...
                                         <div class="mycontent">
                                           <table class="table table-bordered">
                                             ...
                                             <tr>
                                               ...
                                               <td>
                                                   <?php echo Workerdetails::getName($more_plan_details->samjhauta_party);?>
                                               </td>
                                             </tr>
                                             <tr>
                                                         <td><b>पद: </b><?php echo $worker1->post_name;?></td>
                                                         <td><b>पद: </b><?php echo $more_plan_details->post_id_3;?></td>
                                                     </tr>
                                                     <tr>
                                             ...
                                             <tr>
                                               <td colspan="2" class="text-center">मिति: <?php echo convertedcit($more_plan_details->miti); ?></td>
                                             </tr>
                                           </table>
