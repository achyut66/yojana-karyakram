...
<body>
    ...
    <div id="body_wrap_inner"> 
         <div class="maincontent" >
              <h2 class="headinguserprofile">योजना संझौता कार्यादेश |  <a href="<?=$link?>" class="btn">पछि जानुहोस</a></h2>
                  <div class="OurContentFull" >
                    	<form method="get" action="print_bank_report_04_final.php?>" target="_blank" >
...
<div class="chalanino">योजना दर्ता नं : <?php echo convertedcit($_GET['id'])?></div>
										...
										<div class="banktextdetails"  >
                                            ...
                                            <table class="table table-bordered table-responsive myWidth100">
                                                ...
                                                <tr>
                                                	<td class="myTextalignRight">विषयगत क्षेत्र किसिम : </td>
