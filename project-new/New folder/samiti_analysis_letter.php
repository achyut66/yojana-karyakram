    	...
    	<div class="">
            <div class="">
                ...
                <div class="maincontent" >
                    <h2 class="headinguserprofile">विषय:- रकम भुक्तानी सम्बन्धमा | <a class="btn" href="samiti_letters_select.php"> पछी  जानुहोस </a></h2>
                   
                    <div class="OurContentFull" >
                    	<h2>विषय:- रकम भुक्तानी सम्बन्धमा । </h2> 
                      <form method="get" action="samiti_analysis_letter_final.php?id=<?=$_GET['id']?>" target="_blank" >
...
<h5 class="margin1em letter_title_three"><?php echo SITE_ADDRESS;?></h5>
									...
									<div class="printContent">
										...
										<div class="subject">   विषय:- मुल्यांकन अनुसार रकम  भुक्तानी सम्बन्धमा ।</div>
										<div class="myspacer20"></div>
										...
										<div class="banktextdetails"  >
											 यस कार्यालयको स्वीकृत वार्षिक कार्यक्रम 
                                                                                         ...
                                                                                         मा <?php echo $data1->program_name;?><!--(योजनाको नाम)--> योजना संचालनको कार्यदेश दिइएकोमा मिति <?php echo convertedcit($data2->yojana_sakine_date);?><!--(योजनाको काम सम्पन्न भएको 
