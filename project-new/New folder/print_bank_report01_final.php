             	...
             	<div class="printlogo"><img src="images/emblem_nepal.png" alt="Logo"></div>
									...
									<div class="printContent">
										...
										<div class="banktextdetails">
											उपरोक्त बिषयमा यस <?php echo SITE_TYPE;?> र <b><u><?php echo $data->program_organizer_group_name;?></u></b><!--(योजनाको संचालन गर्ने उपभोक्ता समितिको नाम)--> बिच मिति <?php echo convertedcit($data2->miti);?><!--(योजना संझौता भएको मिति)--> मा <?php echo $data1->program_name;?> योजना संचालन गर्ने भनि संझौता भएकोमा उक्त्त योजना संचालन गर्न उपभोक्ता समितिको नाममा बैंक खाता आबश्यक भएकाले उपभोक्ता समितिका अध्यक्ष श्री <?php echo $data3->name;?><!--(नामथर)--> , सचिब श्री <?php echo $data3_1->name;?><!--(नामथर)--> र कोषाध्यक्ष श्री <?php echo $data3_2->name;?><!--(नामथर)--> को संयुक्त दस्तखतबाट संचालन हुने गरी चल्ती खाता खोली दिनहुन अनुरोध छ ।
										</div>
