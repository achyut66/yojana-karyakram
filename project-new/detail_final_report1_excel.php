                              ...
                              <tr>
                                  ...
                                  // contribution calculation in case of samiti 
                                   ...
                                   // $amanat_final_kharcha = mysqli_fetch_assoc($amanat_final_result);
                                    ...
                                    if(empty($unit_name)){ $unit_name = "वटा";}
                                    $html .='  <tr>
                                          ...
                                          <td>'.convertedcit($suchak_bhar_percent) .'</td>
                                          <td>'.convertedcit($sucha_bhautik_percent).'</td>
                                  ...
                                  $html .='</table>';
                   } // topic area loop ends here 
                 
ob_clean();header("Content-Type: application/xls");header("Content-Disposition: application; filename=detail_final_report.xls");echo $html;
?>